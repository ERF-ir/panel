...
import {listProducts, toggleStatusp} from "@/services/requests/shop/productR";
...
const page = () => {
    ...
    let fetchPosts = async ()=>{
        let responce = await listProducts(getCookie());
    ...
    let changeStatus = async (id)=>{
        let responce =  toggleStatusp(id,getCookie())
        ...
        <>
            <Master>
                ...
                <div className=" py-5 px-10    flex items-center justify-between bg-white shadow-[0_0_10px_#ebebeb] rounded-xl">
                    ...
                    <div>
                        <div className={'flex items-center'}>
                            ...
                            <h1 className={'text-gray-600 text-[1.1rem] ms-2 '}>لیست محصولات</h1>
                        </div>
                ...
                <div className=" py-10 px-14 mt-5 overflow-x-auto  bg-white shadow-[0_0_10px_#ebebeb] rounded-xl">
                    ...
                    <button   className={'py-2.5  mb-5 space-x-2 flex ' +
                    ...
                    <table  className={'w-full border-collapse  text-center bo '}>
...

                        {
                            products.map((product)=>(
                                ...
                                <tr key={product.id} className={'border-y *:py-4 even:bg-gray-50  ' }>
                                    ...
                                    <td>
                                        <label className="switch">
                                            <input defaultChecked={product.status} onChange={()=>changeStatus(product.id)}  type="checkbox"/>
                                    ...
                                    <td>
                                        ...
                                        <div className={'flex items-center  justify-center space-x-3 *:cursor-pointer'}>
                                            ...
                                            {loading[product.id] ? <BeatLoader size={8}  speedMultiplier={0.7} color={'#ff7476'} /> : (
                                                <>
                                            ...
                                            <Dialog>
                                                ...
                                                <DialogContent  >
                                                    <DialogHeader>
                                                        <DialogTitle className={'text-center text-gray-600'} >{product.name}</DialogTitle>
                                                    </DialogHeader>
                                                    <div className={'rounded-lg flex justify-center'}>
                                                        <img alt={'d'}  width={300} src={`http://127.0.0.1:8000/${product.image}`}  />
                    ...
                    {products.length ? '': <div className={'flex justify-center mt-10'}><BeatLoader size={17}   speedMultiplier={0.9} color={'#74dfff'}/></div>}
