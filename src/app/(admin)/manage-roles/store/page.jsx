...
const Page = () => {
    ...
    let [permissionss,setPermissions]= useState([])
                ...
                <div className=" py-5 px-10 w-[85%]   flex items-center justify-between bg-white shadow-[0_0_10px_#ebebeb] rounded-xl">
                    ...
                    <div>
                        <div className={'flex items-center'}>
                            ...
                            <h1 className={'text-gray-600 text-[1.1rem] ms-2 '}>افزودن نقش جدید به سایت</h1>
                        </div>
            ...
            <div className={'flex justify-center mt-3 pb-16'}>
                <div className=" py-10 px-14 mt-5 w-[85%]   bg-white shadow-[0_0_10px_#ebebeb] rounded-xl">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className={'flex-wrap  flex items-center justify-between'}>
                        ...
                        <div className={'w-[50%]'}>
                            <label className={'text-gray-500 block'}>نام نقش:</label>
                            <input {...register("name")} type='text'  placeholder='ادمین' className={'p-3.5 mt-3 w-[75%] ' +
                        ...
                        <div className={'w-full '}>
                            <textarea rows={6} {...register("description")}  placeholder='توضیحات نقش مورد نظر ...' className={'p-3.5 mt-3 w-[80%] ' +
                        ...
                        <div>
                            ...
                            <div className="checkbox-wrapper-13 mt-5">

                                {
                                    permissionss.map((item) => (
                                        <span key={item.id}>
                                            <input {...register("permissions")} value={item.id} id={item.id} type="checkbox"/>
                                            <label htmlFor={item.id} className={'mr-4 text-gray-500'}>{item.name}</label>
