...
const page = () => {
    return (
                ...
                <div className=" py-5 px-10 w-[85%]   flex items-center justify-between bg-white shadow-[0_0_10px_#ebebeb] rounded-xl">
                    ...
                    <div>
                        <div className={'flex items-center'}>
                            ...
                            <h1 className={'text-gray-600 text-[1.1rem] ms-2 '}>افزودن دسته بندی جدید به سایت</h1>
                        </div>
                    ...
                    <div className={'flex  items-center space-x-5'}>
                        ...
                        <svg width="37" className={' cursor-pointer p-1.5  rounded-lg border shadow-lg bg-gray-50 transition-all group-hover:fill-gray-200 duration-200 hover:bg-gray-200 hover:border-gray-200 border-gray-400'} height="39" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
      ...
      <div className={'flex justify-center mt-3 pb-16'}>
          <div className=" py-10 px-14 mt-5 w-[85%] flex-wrap  flex items-center justify-between  bg-white shadow-[0_0_10px_#ebebeb] rounded-xl">
              <div className={'w-[50%]'}>
                  <label className={'text-gray-500 block'}>نام دسته بندی :</label>
                  <input type='text' autoFocus placeholder='ورزشی' className={'p-3.5 mt-3 w-[75%]  shadow-[0_0_2px_#c9c9c9] focus:ring-2 ring-indigo-300  transition-all  text-sm text-gray-500 placeholder:text-sm placeholder:text-gray-300 border border-gray-300 rounded-lg'} />
              </div>
              <div>
              ...
              <div className={'w-full mt-10'}>
                  <button className={'py-2.5 space-x-2 flex items-center  px-4 bg-blue-400  hover:shadow-md ring-blue-200 active:bg-blue-300 ring-4  rounded-lg   text-white transition-all  '}>
